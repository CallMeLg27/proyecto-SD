...
public class JmsGet {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ArrayList<Item> receivedMessages = consumer.receiveBody(ArrayList.class, 15000); // in ms or 15 seconds

			System.out.println("\nReceived message:\n" + receivedMessages);
			System.out.println(receivedMessages.get(1).getCodigo());
			System.out.println(receivedMessages.get(1).getPrecio());
